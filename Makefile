...
TARGET ?= $(BUILDDIR)/ramcrc32bd
else
TARGET ?= $(BUILDDIR)/libramcrc32bd.a
endif
...
$(BUILDDIR)/ramcrc32bd: $(OBJ)
	$(CC) $(CFLAGS) $^ $(LFLAGS) -o $@

$(BUILDDIR)/libramcrc32bd.a: $(OBJ)
	$(AR) rcs $@ $^
...
.PHONY: clean
clean:
	rm -f $(BUILDDIR)/ramcrc32bd
	rm -f $(BUILDDIR)/libramcrc32bd.a
